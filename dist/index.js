...
exports.prismaError = exports.QueryError = void 0;
exports.QueryError = new Map([
...
function getPrismaErrorMessage(p_error) {
    const error = exports.QueryError.get(p_error.code);
    if (!error) {
        return {
